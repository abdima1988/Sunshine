 ...
 */
package com.example.dmitry.sunshine.app.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeather(Uri uri, String[] projection, String selection, String[] selectionArgs,
                              String sortOrder) {
    ...
    private Cursor getLocations(Uri uri, String[] projection, String selection, String[] selectionArgs,
                              String sortOrder) {
        ...
        switch (match) {
            ...
            case LOCATION:
                ...
                if (_id > 0) {
                    ...
                    throw new SQLException("Failed to insert location row " + uri);
                }
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER:
                ...
                break;
            case LOCATION:
                rowsInserted = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
